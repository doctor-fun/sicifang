package com.tensquare.eureka.base.service;

import com.tensquare.eureka.base.dao.LabelDao;
    ...
    public List<Label> findSearch(Label label) {
            return labelDao.findAll(new Specification<Label>() {
                ...
                public Predicate toPredicate(Root<Label> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                   ...
                   List<Predicate> list = new ArrayList<>();//new一个list集合，来存放所有的条件
                    if(label.getLabelname()!=null && !"".equals(label.getLabelname())){//labelname既不等于null也不等于空（""）
                    ...
                    return cb.and(parr);//where labelname like "%小明%"  and state ="1"（and操作就是讲两个predicate合起来
                }
            });
    }
