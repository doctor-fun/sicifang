package com.tensquare.eureka.recruit.service;
...
import com.tensquare.eureka.recruit.dao.RecruitDao;
...
public class RecruitService {
	...
	public List<Recruit> recommend(String state){
		return recruitDao.findTopByStateOrderByCreatetimeDesc(state);//state是个2
	}

	public List<Recruit> newlist(String state){
		return recruitDao.findTopByStateNotOrderByCreatetimeDesc(state);//非0的都是
	}
	/**
	 * 查询全部列表
	 * @return
